...
import sty from "./PlasmicNewsletterComponent.module.css"; // plasmic-import: yjSNZw6YMfdV/css
...
function PlasmicNewsletterComponent__RenderFunc(props) {
  ...
  return (
    ...
    >
      ...
      <div className={classNames(projectcss.all, sty.freeBox__nkQOf)}>
        {(() => {
          const child$Props = {
          ...
          return (
            ...
            >
              <FormItemWrapper
                className={classNames("__wab_instance", sty.formField__xpx8I)}
                hidden={true}
              ...
              <FormItemWrapper
                className={classNames("__wab_instance", sty.formField__fniEm)}
                hidden={true}
                initialValue={undefined}
                label={"created_at"}
                name={"created_at"}
              ...
              <FormItemWrapper
                className={classNames("__wab_instance", sty.formField__yJhGg)}
                label={"email"}
                name={"email"}
                noLabel={true}
              >
                <div className={classNames(projectcss.all, sty.freeBox__qwGjK)}>
                  {(() => {
                    const child$Props = {
