...
import sty from "./PlasmicHomeSection.module.css"; // plasmic-import: JfncXTA_wE1v/css
...
function PlasmicHomeSection__RenderFunc(props) {
  ...
  return (
    ...
    >
      <div className={classNames(projectcss.all, sty.freeBox__aaxaj)}>
        <Stack__
          as={"div"}
          hasGap={true}
          className={classNames(projectcss.all, sty.freeBox__acn0Z)}
        >
          <h1
            className={classNames(
              projectcss.all,
          ...
          <div className={classNames(projectcss.all, sty.freeBox__mlvCx)}>
            <Button
