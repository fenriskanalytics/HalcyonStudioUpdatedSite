...
import sty from "./PlasmicButton.module.css"; // plasmic-import: FsgKuOMK6GHf/css
import CheckSvgIcon from "./icons/PlasmicIcon__CheckSvg"; // plasmic-import: dvQacr3a1XEp/icon
    ...
    <Stack__
      ...
      className={classNames(
        ...
        sty.homeButton,
        {
          ...
          [sty.homeButtonshowEndIcon_shape_rounded]:
            hasVariant($state, "showEndIcon", "showEndIcon") &&
            hasVariant($state, "shape", "rounded"),
          [sty.homeButtonshowEndIcon_size_compact]:
            hasVariant($state, "size", "compact") &&
            hasVariant($state, "showEndIcon", "showEndIcon"),
          [sty.homeButtonshowEndIcon_size_compact_showStartIcon]:
            hasVariant($state, "size", "compact") &&
            hasVariant($state, "showStartIcon", "showStartIcon") &&
            hasVariant($state, "showEndIcon", "showEndIcon"),
          ...
          [sty.homeButtonsize_compact_shape_round]:
      ...
      {(hasVariant($state, "showStartIcon", "showStartIcon") ? true : false) ? (
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <CheckSvgIcon
                className={classNames(projectcss.all, sty.svg__mhwUi)}
                role={"img"}
              />
            ),
      ...
      {(hasVariant($state, "showEndIcon", "showEndIcon") ? true : false) ? (
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <CheckSvgIcon
                className={classNames(projectcss.all, sty.svg__ho99O)}
                role={"img"}
              />
            ),
