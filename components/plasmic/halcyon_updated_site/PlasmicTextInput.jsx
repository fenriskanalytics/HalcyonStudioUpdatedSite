...
import sty from "./PlasmicTextInput.module.css"; // plasmic-import: nup1Y90UTHlf/css
import SearchSvg2Icon from "./icons/PlasmicIcon__SearchSvg2"; // plasmic-import: lDKASLc9WTOH/icon
    ...
    >
      ...
      >
        {renderPlasmicSlot({
          defaultContents: (
            <SearchSvg2Icon
              className={classNames(projectcss.all, sty.svg__gYur)}
              role={"img"}
            />
          ),
      ...
      >
        {renderPlasmicSlot({
          defaultContents: (
            <CheckSvgIcon
              className={classNames(projectcss.all, sty.svg__lAcbG)}
              role={"img"}
            />
          ),
