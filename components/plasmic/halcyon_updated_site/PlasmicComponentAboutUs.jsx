...
import sty from "./PlasmicComponentAboutUs.module.css"; // plasmic-import: 50vNi0gryDKI/css
...
function PlasmicComponentAboutUs__RenderFunc(props) {
  ...
  return (
    ...
    >
      <div className={classNames(projectcss.all, sty.freeBox__vDTcA)}>
        <div
          data-plasmic-name={"columns"}
          data-plasmic-override={overrides.columns}
          className={classNames(projectcss.all, sty.columns)}
        >
          <div className={classNames(projectcss.all, sty.column__gfgsq)}>
            <div className={classNames(projectcss.all, sty.freeBox__iqF3U)}>
              <div
                className={classNames(
                  projectcss.all,
          ...
          <div className={classNames(projectcss.all, sty.column__uqEAz)}>
            <PlasmicImg__
              ...
              loading={"lazy"}
              src={{
                src: "/plasmic/halcyon_updated_site/images/image12.png",
                fullWidth: 1665,
                fullHeight: 1733,
